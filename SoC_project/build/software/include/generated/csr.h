...
/* camara_cntrl */
#define CSR_CAMARA_CNTRL_BASE (CSR_BASE + 0x1800L)
#define CSR_CAMARA_CNTRL_DATAMEM_ADDR (CSR_BASE + 0x1800L)
#define CSR_CAMARA_CNTRL_DATAMEM_SIZE 1
static inline uint32_t camara_cntrl_datamem_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}
#define CSR_CAMARA_CNTRL_DIRMEM_ADDR (CSR_BASE + 0x1804L)
#define CSR_CAMARA_CNTRL_DIRMEM_SIZE 1
static inline uint32_t camara_cntrl_dirmem_read(void) {
	return csr_read_simple((CSR_BASE + 0x1804L));
}
#define CSR_CAMARA_CNTRL_EV_STATUS_ADDR (CSR_BASE + 0x1808L)
...
#define CSR_CAMARA_CNTRL_EV_PENDING_ADDR (CSR_BASE + 0x180cL)
...
#define CSR_CAMARA_CNTRL_EV_ENABLE_ADDR (CSR_BASE + 0x1810L)
