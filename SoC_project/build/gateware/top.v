...
reg           leds_re = 1'd0;
wire    [6:0] switchs_status;
wire          switchs_we;
reg           switchs_re = 1'd0;
wire    [2:0] buttons_status;
wire          buttons_we;
reg           buttons_re = 1'd0;
wire   [15:0] datamem_status;
wire          datamem_we;
reg           datamem_re = 1'd0;
wire   [15:0] dirmem_status;
wire          dirmem_we;
reg           dirmem_re = 1'd0;
wire          irq;
wire          ok_status;
...
reg           csrbank1_datamem_re = 1'd0;
wire   [15:0] csrbank1_datamem_r;
reg           csrbank1_datamem_we = 1'd0;
wire   [15:0] csrbank1_datamem_w;
reg           csrbank1_dirmem_re = 1'd0;
wire   [15:0] csrbank1_dirmem_r;
reg           csrbank1_dirmem_we = 1'd0;
wire   [15:0] csrbank1_dirmem_w;
...
wire    [6:0] csrbank4_in_r;
reg           csrbank4_in_we = 1'd0;
wire    [6:0] csrbank4_in_w;
wire          csrbank4_sel;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *)
reg     [6:0] xilinxmultiregimpl1_regs0 = 7'd0;
(* async_reg = "true", dont_touch = "true" *)
reg     [6:0] xilinxmultiregimpl1_regs1 = 7'd0;
...
assign csrbank1_datamem_r = interface1_bank_bus_dat_w[15:0];
always @(*) begin
    csrbank1_datamem_we <= 1'd0;
    csrbank1_datamem_re <= 1'd0;
    if ((csrbank1_sel & (interface1_bank_bus_adr[8:0] == 1'd0))) begin
        csrbank1_datamem_re <= interface1_bank_bus_we;
        csrbank1_datamem_we <= (~interface1_bank_bus_we);
    end
end
assign csrbank1_dirmem_r = interface1_bank_bus_dat_w[15:0];
always @(*) begin
    csrbank1_dirmem_we <= 1'd0;
    csrbank1_dirmem_re <= 1'd0;
    if ((csrbank1_sel & (interface1_bank_bus_adr[8:0] == 1'd1))) begin
        csrbank1_dirmem_re <= interface1_bank_bus_we;
        csrbank1_dirmem_we <= (~interface1_bank_bus_we);
    end
end
...
assign csrbank1_datamem_w = datamem_status[15:0];
assign datamem_we = csrbank1_datamem_we;
assign csrbank1_dirmem_w = dirmem_status[15:0];
assign dirmem_we = csrbank1_dirmem_we;
...
assign csrbank4_sel = (interface4_bank_bus_adr[13:9] == 1'd1);
assign csrbank4_in_r = interface4_bank_bus_dat_w[6:0];
always @(*) begin
    csrbank4_in_we <= 1'd0;
    csrbank4_in_re <= 1'd0;
...
assign csrbank4_in_w = switchs_status[6:0];
assign switchs_we = csrbank4_in_we;
...
assign csr_interconnect_dat_r = ((((((interface0_bank_bus_dat_r | interface1_bank_bus_dat_r) | interface2_bank_bus_dat_r) | interface3_bank_bus_dat_r) | interface4_bank_bus_dat_r) | interface5_bank_bus_dat_r) | interface6_bank_bus_dat_r);
always @(*) begin
    array_muxed0 <= 30'd0;
    case (grant)
        1'd0: begin
...
assign xilinxmultiregimpl1 = {sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
always @(posedge sys_clk) begin
    ...
    if (csrbank1_sel) begin
        case (interface1_bank_bus_adr[8:0])
            1'd0: begin
                interface1_bank_bus_dat_r <= csrbank1_datamem_w;
            end
            1'd1: begin
                interface1_bank_bus_dat_r <= csrbank1_dirmem_w;
            end
            2'd2: begin
    ...
    datamem_re <= csrbank1_datamem_re;
    dirmem_re <= csrbank1_dirmem_re;
    ...
    xilinxmultiregimpl1_regs0 <= {sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
//------------------------------------------------------------------------------
// Memory rom: 5808-words x 32-bit
//------------------------------------------------------------------------------
...
camara camara(
	...
	.VGA_Vsync_n(vsync),
	.data_mem(datamem_status),
	.dir_mem(dirmem_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-12-05 11:31:17.
//------------------------------------------------------------------------------
