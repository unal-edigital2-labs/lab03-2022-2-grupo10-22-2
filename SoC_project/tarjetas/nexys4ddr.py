...
_io = [
    ...
    ("cam_xclk", 0, Pins("G13"), IOStandard("LVCMOS33")),
    ("cam_pclk", 0, Pins("F13"), IOStandard("LVCMOS33")),
    ("cam_vsync", 0, Pins("E17"), IOStandard("LVCMOS33")),
    ("cam_href", 0, Pins("D17"), IOStandard("LVCMOS33")),
    ("cam_pwdn", 0, Pins("E16"), IOStandard("LVCMOS33")),
    

    ("cam_data_in", 0, Pins("D14"), IOStandard("LVCMOS33")),
    ("cam_data_in", 1, Pins("C17"), IOStandard("LVCMOS33")),
    ("cam_data_in", 2, Pins("F16"), IOStandard("LVCMOS33")),
    ("cam_data_in", 3, Pins("D18"), IOStandard("LVCMOS33")),
    ("cam_data_in", 4, Pins("G16"), IOStandard("LVCMOS33")),
    ("cam_data_in", 5, Pins("E18"), IOStandard("LVCMOS33")),
    ("cam_data_in", 6, Pins("H14"), IOStandard("LVCMOS33")),
    ("cam_data_in", 7, Pins("G17"), IOStandard("LVCMOS33")),
